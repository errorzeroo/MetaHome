...
# 기관명이 같은 경우 첫 번째 데이터만 유지하고 중복 제거
df_filtered = df_filtered.drop_duplicates(subset=['기관명'], keep='first')
df_filtered.tocsv('C:/Lecture/final/병원전처리.csv', index=False, encoding='utf-8-sig')
